...
#SUBDIRS += adiummessagestyle  //temporary disabled Project ERROR: Unknown module(s) in QT: location sensors
...
#SUBDIRS += statistics  //temporary disabled Project ERROR: Unknown module(s) in QT: location sensors
