...
bool CompressFeature::xmppDataIn(IXmppStream *AXmppStream, QByteArray &AData, int AOrder)
{
...
bool CompressFeature::xmppDataOut(IXmppStream *AXmppStream, QByteArray &AData, int AOrder)
{
	if (AXmppStream==FXmppStream && AOrder==XDHO_FEATURE_COMPRESS)
...
bool CompressFeature::xmppStanzaOut(IXmppStream *AXmppStream, Stanza &AStanza, int AOrder)
{
	Q_UNUSED(AXmppStream); Q_UNUSED(AStanza); Q_UNUSED(AOrder);
	return false;
}

QString CompressFeature::featureNS() const
{
	return NS_FEATURE_COMPRESS;
}

IXmppStream * CompressFeature::xmppStream() const
{
	return FXmppStream;
}
...
bool CompressFeature::startZlib()
{
	if (!FZlibInited)
	{
