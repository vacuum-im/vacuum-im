...
if (APPLE)
	set_property(GLOBAL APPEND PROPERTY ALL_PLUGINS_DYLIB_FILES "${CMAKE_INSTALL_PREFIX}/${INSTALL_PLUGINS}/${CMAKE_SHARED_LIBRARY_PREFIX}${PLUGIN_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX}")
endif (APPLE)
