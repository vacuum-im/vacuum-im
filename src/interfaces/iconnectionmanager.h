...
#define CONNECTIONMANAGER_UUID      QUuid("{B54F3B5E-3595-48c2-AB6F-249D4AD18327}")

#define APPLICATION_PROXY_REF_UUID  QUuid("{b919d5c9-6def-43ba-87aa-892d49b9ac67}")
...
public:
	...
	virtual IConnectionEngine *engine() const =0;
...
public:
	...
	virtual QList<QString> connectionEngines() const =0;
	virtual IConnectionEngine *findConnectionEngine(const QString &AEngineId) const =0;
	virtual void registerConnectionEngine(IConnectionEngine *AEngine) =0;
protected:
	virtual void connectionCreated(IConnection *AConnection) =0;
	virtual void connectionDestroyed(IConnection *AConnection) =0;
	...
	virtual void connectionEngineRegistered(IConnectionEngine *AEngine) = 0;
};

Q_DECLARE_INTERFACE(IConnection,"Vacuum.Plugin.IConnection/1.4")
Q_DECLARE_INTERFACE(IConnectionEngine,"Vacuum.Plugin.IConnectionEngine/1.4")
Q_DECLARE_INTERFACE(IConnectionManager,"Vacuum.Plugin.IConnectionManager/1.4")
