...
Q_DECLARE_INTERFACE(IXmppFeatureFactory,"Vacuum.Plugin.IXmppFeatureFactory/1.0");
Q_DECLARE_INTERFACE(IXmppStream, "Vacuum.Plugin.IXmppStream/1.3")
Q_DECLARE_INTERFACE(IXmppStreamManager,"Vacuum.Plugin.IXmppStreamManager/1.3")
