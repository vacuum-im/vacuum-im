...
{
	IPlugin *plugin = FMessageWidgets->pluginManager()->pluginInterface("IPresenceManager").value(0,NULL);
	if (plugin)
	{
	...
	plugin = FMessageWidgets->pluginManager()->pluginInterface("IRosterManager").value(0,NULL);
	if (plugin)
	{
