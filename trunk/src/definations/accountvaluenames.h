#ifndef DEF_ACCOUNTVALUENAMES_H
#define DEF_ACCOUNTVALUENAMES_H

#define AVN_NAME                  "name"
#define AVN_ACTIVE                "active"
#define AVN_STREAM_JID            "streamJid"
#define AVN_PASSWORD              "password"
